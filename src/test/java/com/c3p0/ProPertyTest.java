...
public class ProPertyTest {
    ...
    public void beforeMethod() throws SQLException {
        ...
        System.out.println("最小连接数:"+dataSource.getMinPoolSize());
        System.out.println("初始化时获取的连接数:"+dataSource.getInitialPoolSize());
        System.out.println("最大空闲时间:"+dataSource.getMaxIdleTime());
        ...
        System.out.println("同时获取的连接数:"+dataSource.getAcquireIncrement());
        System.out.println("重复尝试的次数:"+dataSource.getAcquireRetryAttempts());
        System.out.println("-------------------------------------------------------------------");
    }
